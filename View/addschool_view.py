...
class AddSchoolView:
    def __init__(self, root, controller):
        ...
        # Nút "Chỉnh sửa"
        edit_button = ctk.CTkButton(self.content_frame, text="Thêm", fg_color="orange", command=self.edit_info)
    ...
    def edit_info(self):
        ...
        self.controller.add_university(name, location, region, focus,
